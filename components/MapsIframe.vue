<template>
    <div id="googlemaps" class="dashed">
        ...
        <p>
            ...
            et
            <ExternalLink href="https://www.google.com/intl/fr_US/help/terms_maps/" content="voir les
                conditions d’utilisation de Google
                maps" />
        </p>

        <button class="button" id="gMapsConsentBtn">
...
export default {
    ...
    mounted: function () {
        ...
        if (gMapsConsent !== 'yes') {
            document.getElementById("gMapsConsentBtn").addEventListener("click", this.gMapsConsent)
            return;
        }
        this.displayGmaps();
    },
